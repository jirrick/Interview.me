...
--
-- Host: localhost
-- Generation Time: Jan 19, 2016 at 10:47 AM
...
INSERT INTO `jazyk` (`id_jazyk`, `kod`, `nazev`) VALUES
(1, 'cpp', 'C++'),
(2, 'csharp', 'C#'),
(3, 'css', 'CSS'),
(4, 'java', 'Java'),
...
CREATE TABLE IF NOT EXISTS `kandidat` (
  ...
  `id_pokrocile_informace` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mena` (
...
INSERT INTO `mena` (`id_mena`, `nazev`, `kod_meny`) VALUES
(2, NULL, 'EUR'),
(3, NULL, 'CZK'),
(4, NULL, 'USD');
...
CREATE TABLE IF NOT EXISTS `odpoved` (
  ...
  `id_moznost` int(11) DEFAULT NULL,
  `vyplneno` tinyint(1) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `otazka` (
  ...
  KEY `FK_otazka_jazyk` (`id_jazyk`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;

-- --------------------------------------------------------

--
-- Table structure for table `perzonalista_pokrocile_informace`
--

DROP TABLE IF EXISTS `perzonalista_pokrocile_informace`;
CREATE TABLE IF NOT EXISTS `perzonalista_pokrocile_informace` (
  `id_uzivatel` int(11) NOT NULL,
  `id_pokrocile_informace` int(11) NOT NULL,
  `id_perzonalista_pokrocile_informace` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id_perzonalista_pokrocile_informace`),
...
--
-- Table structure for table `pokrocile_informace`
--

DROP TABLE IF EXISTS `pokrocile_informace`;
CREATE TABLE IF NOT EXISTS `pokrocile_informace` (
  `id_pokrocile_informace` int(11) NOT NULL AUTO_INCREMENT,
  `datum_pohovoru` date DEFAULT NULL,
  `vzdelani` varchar(200) COLLATE utf8_czech_ci DEFAULT NULL,
  ...
  `idealni_pozice` varchar(200) COLLATE utf8_czech_ci DEFAULT NULL,
  `datum_zahajeni` date DEFAULT NULL,
  `mzda` int(11) DEFAULT NULL,
  `datum_pristiho_kontaktu` date DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `prirazeny_test` (
  ...
  `id_kandidat` int(11) NOT NULL,
  `odkaz` varchar(64) COLLATE utf8_czech_ci NOT NULL,
  `kontrola` varchar(256) COLLATE utf8_czech_ci NOT NULL,
  `id_status` int(11) NOT NULL,
...
--
-- Table structure for table `uvazek`
--

DROP TABLE IF EXISTS `uvazek`;
CREATE TABLE IF NOT EXISTS `uvazek` (
...
--
-- Dumping data for table `uvazek`
--

INSERT INTO `uvazek` (`id_uvazek`, `nazev`) VALUES
(1, 'HPP'),
(2, 'Agency'),
(3, 'Contractor');
...
ALTER TABLE `kandidat`
  ...
  ADD CONSTRAINT `kandidat_ibfk_1` FOREIGN KEY (`id_pokrocile_informace`) REFERENCES `pokrocile_informace` (`id_pokrocile_informace`);
...
--
ALTER TABLE `otazka`
  ADD CONSTRAINT `FK_otazka_jazyk` FOREIGN KEY (`id_jazyk`) REFERENCES `jazyk` (`id_jazyk`),
...
--
-- Constraints for table `perzonalista_pokrocile_informace`
--
ALTER TABLE `perzonalista_pokrocile_informace`
  ADD CONSTRAINT `perzonalista_pokrocile_informace_ibfk_3` FOREIGN KEY (`id_uzivatel`) REFERENCES `uzivatel` (`id_uzivatel`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `perzonalista_pokrocile_informace_ibfk_4` FOREIGN KEY (`id_pokrocile_informace`) REFERENCES `pokrocile_informace` (`id_pokrocile_informace`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pokrocile_informace`
--
ALTER TABLE `pokrocile_informace`
  ADD CONSTRAINT `pokrocile_informace_ibfk_3` FOREIGN KEY (`id_uvazek`) REFERENCES `uvazek` (`id_uvazek`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `pokrocile_informace_ibfk_4` FOREIGN KEY (`id_mena`) REFERENCES `mena` (`id_mena`);
...
--
ALTER TABLE `zprava`
  ADD CONSTRAINT `zprava_ibfk_5` FOREIGN KEY (`id_kandidat`) REFERENCES `kandidat` (`id_kandidat`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `zprava_ibfk_4` FOREIGN KEY (`id_uzivatel`) REFERENCES `uzivatel` (`id_uzivatel`) ON DELETE CASCADE ON UPDATE CASCADE;
